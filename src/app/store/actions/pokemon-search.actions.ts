...
export const pokemonSearchedSuccessfullyKey: string = '[Pokemon API] Pokemon Searched Successfully'
export const pokemonSearchedSuccessfully = createAction(
	pokemonSearchedSuccessfullyKey,
	props<{pokemon: Pokemon}>()
)

export const pokemonSearchedUnsuccessfullyKey: string = '[Pokemon API] Pokemon Searched Unsuccessfully'
